...
DOMAINS: dict[str, list[str]] = {
    ...
    "fastllm-models": [r"^/admin/models", r"^/admin/providers", r"^/admin/backends/", r"^/admin/fallback-model$"],
    "fastllm-routing": [r"^/admin/virtual-model", r"^/admin/rules", r"^/admin/rule-targets/",
                        r"^/admin/routing/"],
